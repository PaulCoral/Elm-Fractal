...
{
	if (region.ad.G === region.an.G)
	{
		return 'on line ' + region.ad.G;
	}
	return 'on lines ' + region.ad.G + ' through ' + region.an.G;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ap: fragment, ar: host, ay: path, aB: port_, aE: protocol, aF: query};
	});
...
var $author$project$Main$Model = F5(
	function (nbIterations, form, drawing, counter, transform) {
		return {P: counter, o: drawing, f: form, H: nbIterations, k: transform};
	});
var $author$project$Counter$Counter = F2(
	function (upTo, isEnabled) {
		return {at: isEnabled, bg: upTo};
	});
var $author$project$Counter$defaultCounterUpTo = 6;
var $author$project$Counter$initCounter = A2($author$project$Counter$Counter, $author$project$Counter$defaultCounterUpTo, false);
var $author$project$Drawable$DrawingState = F2(
	function (pattern, lines) {
		return {V: lines, _: pattern};
	});
var $author$project$PointSpace$Point = F2(
	function (x, y) {
		return {ag: x, ah: y};
	});
var $author$project$Drawable$initLineLength = 800;
var $author$project$Drawable$initialPoint = A2($author$project$PointSpace$Point, 0, $author$project$Drawable$initLineLength / 2);
var $author$project$PointSpace$pointAdd = F2(
	function (p1, p2) {
		return A2($author$project$PointSpace$Point, p1.ag + p2.ag, p1.ah + p2.ah);
	});
var $author$project$Drawable$initDrawingState = function () {
	var nextPoint = A2(
		$author$project$PointSpace$pointAdd,
		$author$project$Drawable$initialPoint,
		A2($author$project$PointSpace$Point, $author$project$Drawable$initLineLength, 0));
	var initialLine = _Utils_Tuple2($author$project$Drawable$initialPoint, nextPoint);
	return A2(
		$author$project$Drawable$DrawingState,
		_List_Nil,
		_List_fromArray(
			[initialLine]));
}();
var $author$project$Main$ModelForm = F3(
	function (pattern, randomSize, counterIsSet) {
		return {Q: counterIsSet, _: pattern, S: randomSize};
	});
var $author$project$Main$defaultFormPatternText = '';
var $author$project$Main$initModelForm = A3($author$project$Main$ModelForm, $author$project$Main$defaultFormPatternText, 6, $author$project$Counter$initCounter.at);
var $author$project$Main$ModelTransform = F4(
	function (scale, translate, prevPos, mouseClicked) {
		return {Y: mouseClicked, I: prevPos, J: scale, M: translate};
	});
var $author$project$Main$initModelTransform = A4(
	$author$project$Main$ModelTransform,
	1,
	A2($author$project$PointSpace$Point, 0, 0),
	A2($author$project$PointSpace$Point, 0, 0),
	false);
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A5($author$project$Main$Model, 0, $author$project$Main$initModelForm, $author$project$Drawable$initDrawingState, $author$project$Counter$initCounter, $author$project$Main$initModelTransform),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$NextIter = {$: 1};
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {aD: processes, aL: taggers};
	});
...
var $author$project$Counter$timeInterval = 1000;
var $author$project$Main$subscriptions = function (model) {
	var i = model.H;
	var c = model.P;
	var hasNext = c.at && (_Utils_cmp(i, c.bg) < 1);
	return hasNext ? A2(
		$elm$time$Time$every,
		$author$project$Counter$timeInterval,
		function (_v0) {
			return $author$project$Main$NextIter;
		}) : $elm$core$Platform$Sub$none;
};
var $author$project$Main$RandomPresets = function (a) {
	return {$: 8, a: a};
};
var $author$project$Drawable$addPatternToDrawingState = F2(
	function (prev, fracpat) {
		return _Utils_update(
			prev,
			{_: fracpat});
	});
var $elm$core$String$toFloat = _String_toFloat;
var $author$project$FracPattern$degreeAngleFromString = function (str) {
...
var $author$project$FracPattern$anglesFromString = function (str) {
	var filtered = A2(
		...
		str);
	var splited = A2($elm$core$String$split, ',', filtered);
	return A2($elm$core$List$map, $author$project$FracPattern$degreeAngleFromString, splited);
};
var $elm$core$String$fromFloat = _String_fromNumber;
var $author$project$FracPattern$degreeAngleToString = function (deg) {
	return $elm$core$String$fromFloat(deg);
};
...
var $author$project$FracPattern$anglesToString = function (fp) {
	var mapString = A2($elm$core$List$map, $author$project$FracPattern$degreeAngleToString, fp);
	var sepComma = A2($elm$core$List$intersperse, ',', mapString);
	return A3($elm$core$List$foldr, $elm$core$Basics$append, '', sepComma);
};
...
var $author$project$PointSpace$pointNeg = function (p) {
	return A2($author$project$PointSpace$Point, -p.ag, -p.ah);
};
var $author$project$PointSpace$pointSub = F2(
	function (p1, p2) {
		return A2(
			$author$project$PointSpace$pointAdd,
			p1,
			$author$project$PointSpace$pointNeg(p2));
	});
var $author$project$PointSpace$lineToVector = function (l) {
	var _v0 = l;
	var p1 = _v0.a;
	var p2 = _v0.b;
	return A2($author$project$PointSpace$pointSub, p2, p1);
};
var $elm$core$Basics$sqrt = _Basics_sqrt;
var $author$project$PointSpace$vectorSize = function (v) {
	return $elm$core$Basics$sqrt((v.ag * v.ag) + (v.ah * v.ah));
};
var $author$project$PointSpace$lineGetSize = function (line) {
	return $author$project$PointSpace$vectorSize(
		$author$project$PointSpace$lineToVector(line));
};
var $author$project$PointSpace$pointMultByScalar = F2(
	function (p, s) {
		return A2($author$project$PointSpace$Point, p.ag * s, p.ah * s);
	});
var $author$project$PointSpace$vectorToSize = F2(
	function (v, newSize) {
		var originalSize = $author$project$PointSpace$vectorSize(v);
		var scale = newSize / originalSize;
		return A2($author$project$PointSpace$pointMultByScalar, v, scale);
	});
var $author$project$PointSpace$lineToSize = F2(
	function (l, newSize) {
		var vector = $author$project$PointSpace$lineToVector(l);
		var scaled = A2($author$project$PointSpace$vectorToSize, vector, newSize);
		var _v0 = l;
		var p1 = _v0.a;
		var newP2 = A2($author$project$PointSpace$pointAdd, p1, scaled);
		return _Utils_Tuple2(p1, newP2);
	});
var $author$project$Utils$listFlatMap = F2(
	function (func, list) {
		return A3(
			$elm$core$List$foldl,
			$elm$core$Basics$append,
			_List_Nil,
			A2($elm$core$List$map, func, list));
	});
...
var $author$project$PointSpace$vectorRotate = F2(
	function (v, angle) {
		var deg = $elm$core$Basics$degrees(angle);
		var newX = ($elm$core$Basics$cos(deg) * v.ag) - ($elm$core$Basics$sin(deg) * v.ah);
		var newY = ($elm$core$Basics$sin(deg) * v.ag) + ($elm$core$Basics$cos(deg) * v.ah);
		return {ag: newX, ah: newY};
	});
var $author$project$PointSpace$updateVectorFromSymbol = F2(
	function (v, deg) {
		return A2($author$project$PointSpace$vectorRotate, v, -deg);
	});
var $author$project$Drawable$updateLineWithPatternRec = F4(
	function (pat, prevPoint, vector, lines) {
		updateLineWithPatternRec:
		while (true) {
			if (!pat.b) {
				return $elm$core$List$reverse(lines);
			} else {
				var x = pat.a;
				var xs = pat.b;
				var vec = A2($author$project$PointSpace$updateVectorFromSymbol, vector, x);
				var secPoint = A2($author$project$PointSpace$pointAdd, prevPoint, vec);
				var newLine = _Utils_Tuple2(prevPoint, secPoint);
				var $temp$pat = xs,
					$temp$prevPoint = secPoint,
					$temp$vector = vec,
					$temp$lines = A2($elm$core$List$cons, newLine, lines);
				pat = $temp$pat;
				prevPoint = $temp$prevPoint;
				vector = $temp$vector;
				lines = $temp$lines;
				continue updateLineWithPatternRec;
			}
		}
	});
var $author$project$Drawable$updateLineWithPattern = F2(
	function (line, pat) {
		var vector = $author$project$PointSpace$lineToVector(line);
		var _v0 = line;
		var p = _v0.a;
		return A4($author$project$Drawable$updateLineWithPatternRec, pat, p, vector, _List_Nil);
	});
var $author$project$Drawable$updateLinesRec = F2(
	function (pat, lines) {
		var firstLine = function () {
			...
			if (!_v0.$) {
				...
				return _Utils_Tuple2($author$project$Drawable$initialPoint, $author$project$Drawable$initialPoint);
			}
		}();
		var newSize = $author$project$PointSpace$lineGetSize(firstLine) / 3;
		var resizedLines = A2(
			$elm$core$List$map,
			function (n) {
				return A2($author$project$PointSpace$lineToSize, n, newSize);
			},
			lines);
		return A2(
			$author$project$Utils$listFlatMap,
			function (n) {
				return A2($author$project$Drawable$updateLineWithPattern, n, pat);
			},
			resizedLines);
	});
var $author$project$Drawable$updateLines = function (ds) {
	return A2($author$project$Drawable$updateLinesRec, ds._, ds.V);
};
var $author$project$Drawable$updateDrawingState = function (ds) {
	return _Utils_update(
		ds,
		{
			V: $author$project$Drawable$updateLines(ds)
		});
};
var $author$project$Main$nextDrawingIteration = function (model) {
	return $author$project$Drawable$updateDrawingState(model.o);
};
var $author$project$Counter$setCounter = F2(
...
var $author$project$Main$zoomFactor = 1;
var $author$project$Main$updateModelScale = F2(
	function (zoom, model) {
		var prevScale = model.k.J;
		var modeltrans = model.k;
		var factor = function () {
			if (!zoom) {
				return $author$project$Main$zoomFactor;
			} else {
				return -$author$project$Main$zoomFactor;
			}
		}();
...
var $author$project$Main$updateModelTranslate = F3(
	function (newX, newY, model) {
		var modeltrans = model.k;
		var prevPos = modeltrans.I;
		var translate = modeltrans.M;
		var updatedX = (translate.ag + newX) - prevPos.ag;
		var updatedY = (translate.ah + newY) - prevPos.ah;
		var updatedModel = _Utils_update(
			model,
			{
				k: _Utils_update(
					modeltrans,
					{
						I: A2($author$project$PointSpace$Point, newX, newY),
						M: A2($author$project$PointSpace$Point, updatedX, updatedY)
					})
			});
		return model.k.Y ? updatedModel : model;
	});
var $author$project$Main$updateMouseClick = F3(
	function (clicked, point, model) {
		var transform = model.k;
		var prevPos = transform.I;
		return _Utils_update(
			model,
			{
				k: _Utils_update(
	...
	function (msg, model) {
		switch (msg.$) {
			case 0:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							P: A2($author$project$Counter$setCounter, model.P, model.f.Q),
							o: A2(
								$author$project$Drawable$addPatternToDrawingState,
								model.o,
								$author$project$FracPattern$anglesFromString(model.f._))
						}),
					$elm$core$Platform$Cmd$none);
			case 1:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							o: $author$project$Main$nextDrawingIteration(model),
							H: model.H + 1
						}),
					$elm$core$Platform$Cmd$none);
			case 2:
			...
			case 4:
				var zoom = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Main$updateModelScale, zoom, model),
					$elm$core$Platform$Cmd$none);
			case 5:
				var x = msg.a;
				var y = msg.b;
				return _Utils_Tuple2(
					A3($author$project$Main$updateModelTranslate, x, y, model),
					$elm$core$Platform$Cmd$none);
			case 6:
				var clicked = msg.a;
				var x = msg.b;
				...
				return _Utils_Tuple2(
					A3(
						$author$project$Main$updateMouseClick,
						clicked,
						A2($author$project$PointSpace$Point, x, y),
						model),
					$elm$core$Platform$Cmd$none);
			case 7:
				return _Utils_Tuple2(
					...
					A2(
						...
						$author$project$Main$RandomPresets,
						A2(
							$elm$random$Random$list,
							model.f.S,
							A2($elm$random$Random$float, -180, 180))));
			case 8:
				var ls = msg.a;
				var trunc = A2(
					$elm$core$List$map,
					...
					ls);
				var modelform = model.f;
				var newModelform = _Utils_update(
					modelform,
					{
						_: $author$project$FracPattern$anglesToString(trunc)
					});
				var newModel = _Utils_update(
					model,
					{f: newModelform});
...
var $author$project$Main$MouseClick = F3(
	function (a, b, c) {
...
var $author$project$PointSpace$pointToCanvasPoint = function (p) {
	var x = p.ag;
	var y = p.ah;
	return _Utils_Tuple2(x, y);
};
var $author$project$Drawable$linesToShapeRec = F2(
	function (lines, acc) {
		linesToShapeRec:
		while (true) {
			if (!lines.b) {
				...
				var p2 = _v1.b;
				var xs = lines.b;
				var start = $author$project$PointSpace$pointToCanvasPoint(p1);
				var end = $author$project$PointSpace$pointToCanvasPoint(p2);
				var line = A2(
					$elm$core$List$cons,
					A2(
				...
				lines = $temp$lines;
				acc = $temp$acc;
				continue linesToShapeRec;
			}
		}
	});
var $author$project$Drawable$linesToShape = function (lines) {
	return A2($author$project$Drawable$linesToShapeRec, lines, _List_Nil);
};
...
var $author$project$Main$modelTransformToList = function (mt) {
	var s = mt.J;
	var x = mt.M.ag / s;
	var y = mt.M.ah / s;
	return _List_fromArray(
...
var $author$project$Main$mouseMoveDecoder = function (f) {
	return A3(
...
var $author$project$Main$onMouseMove = function (f) {
	return A2(
		$elm$html$Html$Events$on,
		'mousemove',
		$author$project$Main$mouseMoveDecoder(f));
};
...
var $author$project$Main$onMyMouseDown = function (f) {
	return A2(
		$elm$html$Html$Events$on,
		'mousedown',
		$author$project$Main$mouseMoveDecoder(f));
};
var $author$project$Main$onMyMouseUp = function (f) {
	return A2(
		$elm$html$Html$Events$on,
		'mouseup',
		$author$project$Main$mouseMoveDecoder(f));
...
var $joakin$elm_canvas$Canvas$renderTextFill = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$fillText, txt.af, x, y, txt.W),
			A2(
				$elm$core$List$cons,
...
var $joakin$elm_canvas$Canvas$renderTextStroke = F5(
	function (txt, x, y, color, cmds) {
		return A2(
			$elm$core$List$cons,
			A4($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$strokeText, txt.af, x, y, txt.W),
			A2(
				$elm$core$List$cons,
	...
	function (x, y, t, cmds) {
		return A2(
			...
			function () {
				if (!t.$) {
					var image = t.a;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, 0, 0, image.aO, image.aq, x, y, image.aO, image.aq, image.R);
				} else {
					var sprite = t.a;
					var image = t.b;
					return A9($joakin$elm_canvas$Canvas$Internal$CustomElementJsonApi$drawImage, sprite.ag, sprite.ah, sprite.aO, sprite.aq, x, y, sprite.aO, sprite.aq, image.R);
				}
			}(),
			cmds);
	});
				...
				function (tagName, width, height) {
					return (tagName === 'IMG') ? $elm$core$Maybe$Just(
						$joakin$elm_canvas$Canvas$Internal$Texture$TImage(
							{aq: height, R: image, aO: width})) : $elm$core$Maybe$Nothing;
				}),
	...
	function (options, attrs, entities) {
		return A3(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					$elm$html$Html$Attributes$height(options.aq),
					A2(
						$elm$core$List$cons,
						$elm$html$Html$Attributes$width(options.aO),
						attrs))),
			A2(
				$elm$core$List$cons,
...
var $author$project$Main$viewDrawing = function (model) {
	var size = $elm$core$Basics$round($author$project$Drawable$initLineLength);
	return A3(
		$joakin$elm_canvas$Canvas$toHtml,
		_Utils_Tuple2(size, size),
		_List_fromArray(
			[
				$author$project$Main$onMouseMove($author$project$Main$Translate),
				$author$project$Main$onMyMouseUp(
				$author$project$Main$MouseClick(false)),
				$author$project$Main$onMyMouseDown(
				$author$project$Main$MouseClick(true)),
				$elm$html$Html$Events$onMouseOut(
				A3($author$project$Main$MouseClick, false, 0, 0)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$joakin$elm_canvas$Canvas$Settings$fill($avh4$elm_color$Color$black),
						$joakin$elm_canvas$Canvas$Settings$stroke($avh4$elm_color$Color$white),
						$joakin$elm_canvas$Canvas$Settings$Advanced$transform(
						$author$project$Main$modelTransformToList(model.k)),
						$joakin$elm_canvas$Canvas$Settings$Line$lineWidth(1 / model.k.J)
					]),
				$author$project$Drawable$linesToShape(model.o.V))
			]));
};
...
var $author$project$FracPattern$emptyAngles = _List_Nil;
var $author$project$Main$isStartModel = function (model) {
	return _Utils_eq(model.o._, $author$project$FracPattern$emptyAngles);
};
var $author$project$Main$Draw = {$: 0};
var $author$project$Main$GeneratePresets = {$: 7};
...
var $author$project$Main$updatePatternModelForm = F2(
	function (model, s) {
		var prevForm = model.f;
		return $author$project$Main$UpdateForm(
			_Utils_update(
				prevForm,
				{_: s}));
	});
var $author$project$Main$updateRandomSizeModelForm = F2(
	function (model, maybeSize) {
		var size = function () {
			var _v0 = $elm$core$String$toInt(maybeSize);
			if (!_v0.$) {
				var i = _v0.a;
				return i;
			} else {
...
var $author$project$PresetPattern$Preset = F2(
	function (name, pattern) {
		return {a7: name, _: pattern};
	});
var $author$project$PresetPattern$fibonacci = function (i) {
	switch (i) {
		case 0:
			return 0;
		case 1:
			return 1;
		default:
			return $author$project$PresetPattern$fibonacci(i - 1) + $author$project$PresetPattern$fibonacci(i - 2);
	}
};
var $author$project$PresetPattern$fibonacciList = F2(
	function (from, to) {
		var range = A2($elm$core$List$range, from, to);
		return A2($elm$core$List$map, $author$project$PresetPattern$fibonacci, range);
	});
var $author$project$PresetPattern$presetList = _List_fromArray(
	[
		A2(
		$author$project$PresetPattern$Preset,
		'Snow Flake',
		$author$project$FracPattern$anglesToString(
			_List_fromArray(
				[0, 60, -120, 60]))),
		A2(
		$author$project$PresetPattern$Preset,
		...
		'Fibonacci',
		$author$project$FracPattern$anglesToString(
			A2($author$project$PresetPattern$fibonacciList, 3, 9))),
		A2(
		$author$project$PresetPattern$Preset,
		'+Fibonacci',
		$author$project$FracPattern$anglesToString(
			A2($author$project$PresetPattern$fibonacciList, 6, 12))),
		A2(
		$author$project$PresetPattern$Preset,
		'++Fibonacci',
		$author$project$FracPattern$anglesToString(
			A2($author$project$PresetPattern$fibonacciList, 9, 15)))
	]);
var $elm$html$Html$select = _VirtualDom_node('select');
var $author$project$Main$viewCommandPreset = function (model) {
	var form = model.f;
	var options = A2(
		$elm$core$List$cons,
		A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$value(form._)
				]),
			_List_fromArray(
				[
		...
		A2(
			...
			function (preset) {
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$value(preset._)
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(preset.a7)
						]));
			},
			$author$project$PresetPattern$presetList));
	return A2(
...
var $author$project$Main$viewCommandInit = function (model) {
	var form = model.f;
	return A2(
		$elm$html$Html$div,
		_List_Nil,
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(form._),
						$elm$html$Html$Events$onInput(
						$author$project$Main$updatePatternModelForm(model))
					]),
				_List_Nil),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$author$project$Main$viewCommandPreset(model),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text('Random : size = '),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$core$String$fromInt(form.S)),
						$elm$html$Html$Events$onInput(
						$author$project$Main$updateRandomSizeModelForm(model)),
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$GeneratePresets)
					]),
				_List_fromArray(
					[
				...
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text('Animated ?'),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('checkbox'),
						$elm$html$Html$Attributes$checked(model.f.Q),
...
var $author$project$Main$In = 0;
var $author$project$Main$Out = 1;
var $author$project$Main$Scale = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$viewCommandUpdate = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Pattern : ' + $author$project$FracPattern$anglesToString(model.o._)),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				'Number of iterations : ' + $elm$core$String$fromInt(model.H)),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				'Number of drawn lines :' + $elm$core$String$fromInt(
					$elm$core$List$length(model.o.V))),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$NextIter)
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewCommand = function (model) {
	return $author$project$Main$isStartModel(model) ? $author$project$Main$viewCommandInit(model) : $author$project$Main$viewCommandUpdate(model);
};
var $author$project$Main$viewText = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Elm Fractal')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Have a look at my '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/PaulCoral/Elm-Fractal')
							]),
						_List_fromArray(
							[
				...
				$author$project$Main$viewCommand(model)
			]));
};
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$viewText(model),
				$author$project$Main$viewDrawing(model)
			]));
};
