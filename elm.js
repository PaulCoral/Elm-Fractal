...
var $author$project$Main$Model = F4(
	function (nbIterations, form, drawing, counter) {
		return {counter: counter, drawing: drawing, form: form, nbIterations: nbIterations};
	});
var $author$project$Counter$Counter = F2(
	function (upTo, isEnabled) {
		return {isEnabled: isEnabled, upTo: upTo};
	});
...
var $author$project$PointSpace$pointAdd = F2(
	function (p1, p2) {
		return A2($author$project$PointSpace$Point, p1.x + p2.x, p1.y + p2.y);
	});
...
var $author$project$Main$ModelForm = F2(
	function (pattern, counterIsSet) {
		return {counterIsSet: counterIsSet, pattern: pattern};
	});
var $author$project$Main$defaultFormPatternText = '';
var $author$project$Main$initModelForm = A2($author$project$Main$ModelForm, $author$project$Main$defaultFormPatternText, $author$project$Counter$initCounter.isEnabled);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		A4($author$project$Main$Model, 1, $author$project$Main$initModelForm, $author$project$Drawable$initDrawingState, $author$project$Counter$initCounter),
		$elm$core$Platform$Cmd$none);
};
var $author$project$Main$NextIter = {$: 'NextIter'};
...
var $author$project$Main$subscriptions = function (model) {
	var i = model.nbIterations;
	var c = model.counter;
	var hasNext = c.isEnabled && (_Utils_cmp(i, c.upTo) < 1);
	return hasNext ? A2(
		$elm$time$Time$every,
...
var $author$project$PointSpace$pointNeg = function (p) {
	return A2($author$project$PointSpace$Point, -p.x, -p.y);
};
...
var $author$project$PointSpace$pointMultByScalar = F2(
	function (p, s) {
		return A2($author$project$PointSpace$Point, p.x * s, p.y * s);
	});
...
var $author$project$PointSpace$vectorRotate = F2(
	function (v, angle) {
		...
		var newX = ($elm$core$Basics$cos(deg) * v.x) - ($elm$core$Basics$sin(deg) * v.y);
		var newY = ($elm$core$Basics$sin(deg) * v.x) + ($elm$core$Basics$cos(deg) * v.y);
...
var $author$project$Drawable$updateLines = function (ds) {
	return A2($author$project$Drawable$updateLinesRec, ds.pattern, ds.lines);
};
var $author$project$Drawable$updateDrawingState = function (ds) {
	return _Utils_update(
		ds,
		{
			lines: $author$project$Drawable$updateLines(ds)
		});
};
var $author$project$Main$nextDrawingIteration = function (model) {
	return $author$project$Drawable$updateDrawingState(model.drawing);
};
			...
			case 'Draw':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							counter: A2($author$project$Counter$setCounter, model.counter, model.form.counterIsSet),
							drawing: A2(
								$author$project$Drawable$addPatternToDrawingState,
								model.drawing,
								$author$project$FracPattern$anglesFromString(model.form.pattern))
						}),
					$elm$core$Platform$Cmd$none);
			case 'NextIter':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							drawing: $author$project$Main$nextDrawingIteration(model),
							nbIterations: model.nbIterations + 1
						}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
				var _v1 = $author$project$Main$init(_Utils_Tuple0);
				var m = _v1.a;
				var cmd = _v1.b;
...
var $author$project$Main$viewDrawing = function (model) {
	...
	var width = size;
	var lines = $author$project$Drawable$linesToShape(model.drawing.lines);
	var length = A2($elm$core$Debug$log, 'Length', lines);
	var height = size;
	return A3(
		...
		_List_fromArray(
			[
				...
				$author$project$Drawable$linesToShape(model.drawing.lines))
			]));
};
...
var $author$project$Main$isStartModel = function (model) {
	return _Utils_eq(model.drawing.pattern, $author$project$FracPattern$emptyAngles);
};
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$value(form.pattern)
					]),
				_List_fromArray(
					[
			...
			A2(
				...
				function (preset) {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(preset.pattern)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(preset.name)
							]));
				},
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$checked(model.form.counterIsSet),
...
var $author$project$Main$viewCommandUpdate = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				'Pattern : ' + $author$project$FracPattern$anglesToString(model.drawing.pattern)),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				'Number of iterations : ' + $elm$core$String$fromInt(model.nbIterations)),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				'Number of drawn lines :' + $elm$core$String$fromInt(
					$elm$core$List$length(model.drawing.lines))),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://github.com/lepaincestbon/Elm-Fractal')
							]),
						_List_fromArray(
							[
